...
async function alphaLoadConfigFactory(){await Promise.all([alphaLoadConfigRepo("ip"),alphaLoadConfigRepo("proxy"),alphaLoadConfigUsers(),alphaLoadConfigTemplates(),alphaLoadConfigSnapshots()]);alphaSetConfigMode(alphaConfigMode)}
